...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const QUIZ_BY_THEME = {
    historia: [
      ...
      { q:"Em que cidade foi escolhida a data do Dia da Criança, em 1949?", a:[{t:"Moscovo",ok:true},{t:"Paris",ok:false},{t:"Nova Iorque",ok:false}], exp:"Foi numa conferência em Moscovo, em novembro de 1949, que a Federação Democrática Internacional das Mulheres decidiu estabelecer o 1 de junho como Dia Internacional de Proteção das Crianças." },
      { q:"Que acontecimento histórico motivou a criação do Dia da Criança?", a:[{t:"As consequências da Segunda Guerra Mundial para as crianças",ok:true},{t:"A chegada do Homem à Lua",ok:false},{t:"A fundação da União Europeia",ok:false}], exp:"O fim da Segunda Guerra Mundial (1945) deixou milhões de crianças deslocadas e traumatizadas. Isso impulsionou movimentos internacionais para proteger os mais novos, levando à criação do Dia da Criança em 1950." },
      { q:"O Dia da Criança é celebrado no mesmo dia em todos os países?", a:[{t:"Não — em muitos países celebra-se a 20 de novembro",ok:true},{t:"Sim, sempre a 1 de junho em todo o mundo",ok:false},{t:"Não há um dia fixo — cada escola decide",ok:false}], exp:"Enquanto Portugal e muitos países celebram a 1 de junho, o Dia Universal da Criança é a 20 de novembro (data da Convenção da ONU de 1989). Alguns países têm ainda datas próprias." },
      { q:"Qual das seguintes afirmações sobre o Dia da Criança é verdadeira?", a:[{t:"É uma oportunidade para lembrar que os direitos das crianças ainda precisam de ser defendidos",ok:true},{t:"É apenas uma festa comercial sem significado real",ok:false},{t:"Só é celebrado em países europeus",ok:false}], exp:"O Dia da Criança tem um significado profundo: lembrar que, embora os direitos das crianças estejam consagrados em documentos internacionais, ainda há milhões de crianças no mundo cujos direitos não são respeitados." },
      { q:"Que organização internacional foi criada em 1946 para ajudar as crianças afetadas pela guerra?", a:[{t:"A UNICEF",ok:true},{t:"A UNESCO",ok:false},{t:"A Cruz Vermelha",ok:false}], exp:"A UNICEF (Fundo das Nações Unidas para a Infância) foi criada em 1946, logo após a Segunda Guerra Mundial, para prestar auxílio de emergência às crianças afetadas pelo conflito na Europa e na Ásia." }
    ,
      { q:"Quando se celebra o Dia da Criança em Portugal?", a:[{t:"1 de junho",ok:true},{t:"1 de janeiro",ok:false},{t:"25 de dezembro",ok:false}], exp:"O Dia da Criança celebra-se a 1 de junho em Portugal. Esta data foi escolhida para lembrar que todas as crianças merecem brincadeiras, alegria e respeito pelos seus direitos." },
      { q:"O Dia da Criança é um dia para celebrar que aspeto?", a:[{t:"Os direitos e a alegria das crianças",ok:true},{t:"Só os professores",ok:false},{t:"Apenas os adultos",ok:false}], exp:"O Dia da Criança serve para celebrar e relembrar os direitos de todas as crianças — à educação, à saúde, ao brincar e à proteção." },
      { q:"Qual destes é um símbolo do Dia da Criança?", a:[{t:"Um balão colorido e sorrisos",ok:true},{t:"Uma gravata",ok:false},{t:"Um computador",ok:false}], exp:"O balão colorido, os sorrisos e as festas são símbolos do Dia da Criança — um dia de alegria e celebração dos direitos das crianças." },
      { q:"As crianças de todo o mundo têm os mesmos direitos?", a:[{t:"Sim, são direitos universais",ok:true},{t:"Não, depende do país",ok:false},{t:"Só as crianças europeias",ok:false}], exp:"A Convenção dos Direitos da Criança da ONU (1989) garante que todas as crianças do mundo têm os mesmos direitos, sem qualquer discriminação." },
      { q:"O que podemos fazer no Dia da Criança?", a:[{t:"Celebrar, brincar e aprender sobre os direitos das crianças",ok:true},{t:"Trabalhar o dia todo",ok:false},{t:"Não fazer nada especial",ok:false}], exp:"O Dia da Criança é uma oportunidade para celebrar, brincar e aprender sobre os direitos das crianças e o que ainda falta garantir a nível mundial." }
    ],
    declaracao: [
      ...
      { q:"Em que data foi aprovada a Declaração dos Direitos da Criança de 1959?", a:[{t:"20 de novembro de 1959",ok:true},{t:"1 de junho de 1959",ok:false},{t:"10 de dezembro de 1959",ok:false}], exp:"A Declaração foi aprovada a 20 de novembro de 1959, exatamente 30 anos antes da Convenção de 1989. Por isso, o 20 de novembro é hoje celebrado como o Dia Universal da Criança." },
      { q:"Qual é a diferença entre a Declaração de 1959 e a Convenção de 1989?", a:[{t:"A Convenção tem força legal obrigatória; a Declaração era apenas moral",ok:true},{t:"A Declaração tem mais artigos do que a Convenção",ok:false},{t:"São documentos idênticos com nomes diferentes",ok:false}], exp:"A Declaração de 1959 tinha 10 princípios sem força legal. A Convenção de 1989, com 54 artigos, é um tratado internacional vinculativo — os países que a ratificam são obrigados a cumpri-la e a adaptar as suas leis." },
      { q:"Que documento sobre direitos da criança existia antes da Declaração de 1959?", a:[{t:"A Declaração de Genebra de 1924, aprovada pela Liga das Nações",ok:true},{t:"A Carta das Nações Unidas de 1945",ok:false},{t:"O Tratado de Versalhes de 1919",ok:false}], exp:"A Declaração de Genebra de 1924 foi o primeiro documento internacional sobre proteção da infância, aprovado pela Liga das Nações. Tinha 5 princípios básicos e serviu de inspiração para a Declaração mais completa de 1959." },
      { q:"Qual era o principal princípio da Declaração de 1959 em relação à discriminação?", a:[{t:"Nenhuma criança pode ser discriminada por raça, cor, sexo, língua ou religião",ok:true},{t:"Apenas as crianças de países membros da ONU tinham direitos reconhecidos",ok:false},{t:"As crianças podiam ser tratadas de forma diferente consoante a sua origem",ok:false}], exp:"O Princípio 1 da Declaração de 1959 estabelecia que todas as crianças têm os direitos enunciados, sem qualquer exceção ou distinção por raça, cor, sexo, língua, religião, opinião política ou origem nacional." }
    ],
    convencao: [
      ...
      { q:"Qual é o 'princípio do interesse superior da criança' da Convenção?", a:[{t:"Em todas as decisões, o bem-estar da criança deve ser a prioridade máxima",ok:true},{t:"As crianças têm mais direitos do que os adultos",ok:false},{t:"O Estado pode decidir pelo bem da criança sem ouvir os pais",ok:false}], exp:"O artigo 3.º da Convenção estabelece que, em todas as ações relativas a crianças, o interesse superior da criança deve ser uma consideração primordial — seja por tribunais, autoridades ou famílias." },
      { q:"A Convenção aplica-se a todas as crianças do mundo, independentemente da sua origem?", a:[{t:"Sim, aplica-se a todas as crianças sem discriminação",ok:true},{t:"Só se aplica a crianças de países que a ratificaram",ok:false},{t:"Só se aplica a crianças com mais de 5 anos",ok:false}], exp:"O artigo 2.º proíbe qualquer discriminação — os direitos aplicam-se a todas as crianças, independentemente de raça, cor, sexo, língua, religião ou origem. Mesmo crianças de países que não ratificaram a Convenção têm os seus direitos reconhecidos internacionalmente." },
      { q:"O que é o Comité dos Direitos da Criança da ONU?", a:[{t:"O órgão que fiscaliza se os países cumprem a Convenção",ok:true},{t:"Um tribunal que julga crimes contra crianças",ok:false},{t:"Uma organização que distribui brinquedos a crianças pobres",ok:false}], exp:"O Comité dos Direitos da Criança é um órgão de especialistas independentes que monitoriza a aplicação da Convenção. Os países signatários devem apresentar relatórios periódicos sobre o cumprimento dos direitos das crianças." },
      { q:"Até que idade se aplica a Convenção dos Direitos da Criança?", a:[{t:"Até aos 18 anos",ok:true},{t:"Até aos 16 anos",ok:false},{t:"Até aos 21 anos",ok:false}], exp:"O artigo 1.º define 'criança' como todo o ser humano menor de 18 anos, salvo se a lei nacional aplicável estabelecer a maioridade mais cedo. Em Portugal, a maioridade é aos 18 anos." },
      { q:"O que significa 'ratificar' a Convenção dos Direitos da Criança?", a:[{t:"Um país aceitar formalmente o tratado e comprometer-se a cumpri-lo em lei",ok:true},{t:"Um país ter sido convidado a participar na ONU",ok:false},{t:"Um país traduzir a Convenção para a sua língua",ok:false}], exp:"Ratificar um tratado internacional significa que um país o aprova formalmente através do seu processo legislativo nacional e se compromete juridicamente a cumpri-lo. Os países que ratificam a CDC devem adaptar as suas leis internas para garantir os direitos das crianças." }
    ,
      { q:"Em que data é o Dia Universal da Criança?", a:[{t:"20 de novembro",ok:true},{t:"1 de junho",ok:false},{t:"25 de abril",ok:false}], exp:"O Dia Universal da Criança celebra-se a 20 de novembro — data em que a Convenção foi aprovada pela ONU em 1989. Portugal celebra o 1 de junho como Dia da Criança." },
      { q:"Quantos países ratificaram a Convenção dos Direitos da Criança?", a:[{t:"Mais de 190 países",ok:true},{t:"Menos de 50 países",ok:false},{t:"Cerca de 100 países",ok:false}], exp:"Mais de 196 países ratificaram a Convenção — praticamente todos os países do mundo. Isto torna-a o tratado de direitos humanos mais amplamente aceite na história da ONU." },
      { q:"Que organização aprovou a Convenção sobre os Direitos da Criança?", a:[{t:"ONU — Organização das Nações Unidas",ok:true},{t:"FIFA",ok:false},{t:"União Europeia",ok:false}], exp:"A Convenção foi aprovada pela Assembleia Geral da ONU a 20 de novembro de 1989. É o tratado de direitos humanos mais ratificado da história, com 196 países signatários." }
    ],
    brincar: [
      ...
      { q:"Que competências desenvolve o jogo livre nas crianças?", a:[{t:"Criatividade, negociação, resolução de conflitos e autonomia",ok:true},{t:"Apenas velocidade de raciocínio matemático",ok:false},{t:"Só a condição física",ok:false}], exp:"Quando as crianças brincam livremente — sem direção dos adultos — aprendem a negociar regras, a resolver conflitos, a ser criativas e a tomar decisões. Estas são competências fundamentais para a vida adulta que nenhum currículo académico consegue substituir." },
      { q:"Qual a recomendação da OMS sobre atividade física para crianças dos 6 aos 17 anos?", a:[{t:"Pelo menos 60 minutos de atividade física moderada a vigorosa por dia",ok:true},{t:"Apenas 20 minutos por semana",ok:false},{t:"Atividade física só aos fins de semana",ok:false}], exp:"A Organização Mundial de Saúde recomenda que crianças e adolescentes entre os 6 e os 17 anos pratiquem pelo menos 60 minutos de atividade física moderada a vigorosa por dia. O brincar ao ar livre é uma das melhores formas de cumprir esta recomendação." },
      { q:"O que é o 'jogo não estruturado' e qual é a sua importância?", a:[{t:"É o brincar livre, sem regras impostas por adultos, essencial para o desenvolvimento",ok:true},{t:"É um tipo de jogo perigoso sem supervisão",ok:false},{t:"São apenas atividades desportivas sem árbitro",ok:false}], exp:"O jogo não estruturado é aquele em que a criança decide livremente como, com quem e ao que quer brincar. A investigação mostra que este tipo de jogo é especialmente valioso para desenvolver criatividade, autonomia e competências sociais — muito mais do que atividades organizadas por adultos." },
      { q:"O que podem os pais e educadores fazer para proteger o direito ao brincar?", a:[{t:"Garantir tempo livre diário, espaços seguros e não sobrecarregar com atividades",ok:true},{t:"Organizar todas as brincadeiras para garantir que são educativas",ok:false},{t:"Proibir o jogo livre para prevenir acidentes",ok:false}], exp:"Os adultos têm um papel fundamental: reservar tempo para a brincadeira livre no horário diário, criar espaços seguros onde as crianças possam explorar, e evitar sobrecarregar os horários com atividades extracurriculares que não deixam espaço para o brincar espontâneo." }
    ,
      { q:"Brincar é um direito ou um privilégio?", a:[{t:"É um direito — todas as crianças têm direito a brincar",ok:true},{t:"É um privilégio para quem se porta bem",ok:false},{t:"Só é direito até aos 5 anos",ok:false}], exp:"O artigo 31.º da Convenção dos Direitos da Criança garante que brincar é um direito fundamental — não um privilégio. É essencial para o desenvolvimento saudável." },
      { q:"O que devemos fazer se uma criança está triste no parque?", a:[{t:"Ajudar e ser amigo",ok:true},{t:"Ignorar",ok:false},{t:"Rir dela",ok:false}], exp:"Ajudar uma criança em dificuldade é um ato de cidadania. A Convenção reconhece o direito das crianças à amizade e à participação social." },
      { q:"As crianças têm direito a viver sem violência?", a:[{t:"Sim, a segurança é um direito fundamental",ok:true},{t:"Não, a violência é inevitável",ok:false},{t:"Apenas dentro de casa",ok:false}], exp:"O artigo 19.º da Convenção protege as crianças de todas as formas de violência. A segurança é um direito universal que se aplica em todos os contextos." },
      { q:"O que torna um recreio escolar seguro e divertido?", a:[{t:"Brincar em liberdade, regras claras e respeito mútuo",ok:true},{t:"Só ecrãs e videojogos",ok:false},{t:"Silêncio obrigatório",ok:false}], exp:"Um recreio seguro combina espaço para brincar livremente, regras compreendidas por todos e uma cultura de respeito. A escola tem obrigação de garantir este direito no dia a dia." }
    ],
    educacao: [
      ...
      { q:"Qual é o Objetivo de Desenvolvimento Sustentável relacionado com a educação?", a:[{t:"ODS 4 — Educação de Qualidade",ok:true},{t:"ODS 1 — Erradicar a Pobreza",ok:false},{t:"ODS 10 — Reduzir as Desigualdades",ok:false}], exp:"O ODS 4 visa garantir educação inclusiva, equitativa e de qualidade, e promover oportunidades de aprendizagem ao longo da vida para todos, até 2030. Ainda há muito trabalho a fazer: 244 milhões de crianças continuam fora da escola." },
      { q:"O que é a 'educação para a cidadania' e por que é importante?", a:[{t:"É o ensino dos direitos, deveres e valores que permitem participar ativamente na sociedade",ok:true},{t:"É uma disciplina apenas sobre leis e tribunais",ok:false},{t:"É apenas para crianças que querem ser políticos",ok:false}], exp:"A educação para a cidadania — prevista nos objetivos da educação do artigo 29.º — ensina as crianças a conhecer os seus direitos e deveres, a respeitar os outros, a participar democraticamente e a contribuir para uma sociedade justa e pacífica." },
      { q:"Por que razão as raparigas têm menos acesso à educação em certas regiões do mundo?", a:[{t:"Por discriminação de género, pobreza, casamento precoce e normas culturais",ok:true},{t:"Porque a ONU proibiu a educação feminina em alguns países",ok:false},{t:"Porque as raparigas não querem estudar nessas regiões",ok:false}], exp:"Em certas regiões, as raparigas enfrentam barreiras específicas: discriminação de género, obrigação de trabalhar em casa, casamento precoce, gravidez na adolescência e insegurança no caminho para a escola. A UNICEF trabalha para superar estas barreiras através de programas de apoio específicos." },
      { q:"O que é a 'literacia' e qual é a sua importância para as crianças?", a:[{t:"É a capacidade de ler e escrever — base de todo o desenvolvimento e aprendizagem",ok:true},{t:"É saber programar computadores",ok:false},{t:"É dominar uma língua estrangeira",ok:false}], exp:"A literacia — a capacidade de ler e escrever — é a fundação de toda a aprendizagem. Sem ela, uma criança não consegue aceder a outros conhecimentos, defender os seus direitos ou participar na sociedade. Em Portugal, a taxa de literacia está acima de 95%, mas globalmente ainda há 771 milhões de adultos analfabetos." }
    ,
      { q:"Quem disse 'a educação é a arma mais poderosa para mudar o mundo'?", a:[{t:"Nelson Mandela",ok:true},{t:"Napoleão Bonaparte",ok:false},{t:"Albert Einstein",ok:false}], exp:"Nelson Mandela, líder sul-africano e Nobel da Paz, disse esta frase icónica. Ele próprio vivenciou o poder da educação como instrumento de libertação e mudança social." },
      { q:"O que é o analfabetismo?", a:[{t:"Incapacidade de ler e escrever",ok:true},{t:"Gostar muito de ler",ok:false},{t:"Aprender línguas estrangeiras",ok:false}], exp:"O analfabetismo é a incapacidade de ler e escrever. No mundo, ainda há 771 milhões de adultos analfabetos — muitos começaram por ser crianças sem acesso à escola." },
      { q:"O que se celebra a 5 de outubro em Portugal?", a:[{t:"O Dia do Professor",ok:true},{t:"O Dia da Criança",ok:false},{t:"O Dia da Mãe",ok:false}], exp:"O 5 de outubro é o Dia do Professor em Portugal. É também a data da implantação da República (1910). A profissão docente é fundamental para garantir o direito à educação." },
      { q:"Qual é o principal papel de um professor?", a:[{t:"Ensinar, guiar e apoiar o desenvolvimento dos alunos",ok:true},{t:"Apenas vigiar os alunos",ok:false},{t:"Só dar testes e fichas",ok:false}], exp:"Os professores realizam o direito à educação (artigo 28.º da CDC): ensinam, orientam, apoiam o desenvolvimento integral e ajudam cada aluno a atingir o seu potencial." }
    ],
    saude: [
      ...
      { q:"O que é a saúde mental e por que é importante nas crianças?", a:[{t:"É o bem-estar emocional e psicológico — tão importante como a saúde física",ok:true},{t:"É apenas para crianças com doenças graves",ok:false},{t:"Não é uma preocupação antes dos 18 anos",ok:false}], exp:"A saúde mental inclui o bem-estar emocional, psicológico e social. Problemas como ansiedade, depressão e perturbações do comportamento podem afetar crianças de todas as idades. O artigo 24.º da CDC inclui a saúde mental, e a OMS alerta que 50% das doenças mentais surgem antes dos 14 anos." },
      { q:"O que é a desnutrição infantil e que consequências tem?", a:[{t:"É a falta de nutrientes essenciais — afeta o crescimento, o cérebro e o sistema imunitário",ok:true},{t:"É apenas estar com fome durante um dia",ok:false},{t:"É um problema que só afeta adultos",ok:false}], exp:"A desnutrição crónica afeta o desenvolvimento físico e cognitivo das crianças de forma irreversível. Segundo a UNICEF, 45% das mortes infantis estão relacionadas com a desnutrição. Os primeiros 1000 dias de vida são críticos para o desenvolvimento cerebral." },
      { q:"Que número pode uma criança em Portugal ligar em caso de emergência de saúde?", a:[{t:"112 — o número de emergência médica",ok:true},{t:"116 111 — SOS Criança",ok:false},{t:"808 24 24 24 — Linha de Saúde",ok:false}], exp:"O 112 é o número europeu de emergência, incluindo emergências médicas. A Linha de Saúde 24 (808 24 24 24) dá orientação médica não urgente. O 116 111 é a linha SOS Criança, para situações de risco e não emergências médicas." },
      { q:"O que é a 'promoção da saúde' e como se aplica às crianças?", a:[{t:"Conjunto de ações para melhorar e proteger a saúde antes que surjam doenças",ok:true},{t:"Um programa de medicamentos preventivos para todos",ok:false},{t:"Apenas consultas médicas de rotina",ok:false}], exp:"A promoção da saúde inclui educação alimentar, exercício físico, higiene, saúde mental e prevenção de acidentes. Nas escolas portuguesas, o Programa Nacional de Saúde Escolar apoia as crianças com rastreios, vacinação e literacia em saúde." }
    ,
      { q:"Quantas horas deve dormir uma criança de 8 anos?", a:[{t:"9 a 11 horas",ok:true},{t:"4 a 5 horas",ok:false},{t:"6 a 7 horas",ok:false}], exp:"A OMS recomenda 9 a 11 horas de sono por noite para crianças em idade escolar. Dormir bem é fundamental para o crescimento, a memória e o bem-estar." },
      { q:"Qual destes é um hábito saudável?", a:[{t:"Lavar os dentes todos os dias",ok:true},{t:"Passar 10 horas seguidas no ecrã",ok:false},{t:"Comer só fast food",ok:false}], exp:"Lavar os dentes diariamente previne cáries e doenças orais. A saúde oral faz parte do direito à saúde (artigo 24.º da CDC) e deve ser cuidada desde bebé." },
      { q:"Quantos copos de água se deve beber por dia?", a:[{t:"6 a 8 copos",ok:true},{t:"1 copo",ok:false},{t:"20 copos",ok:false}], exp:"Os especialistas recomendam 6 a 8 copos de água por dia para crianças. Uma boa hidratação melhora a concentração, o humor e o desempenho físico e cognitivo." },
      { q:"O que deve uma criança fazer quando se sente muito triste ou ansiosa?", a:[{t:"Falar com um adulto de confiança",ok:true},{t:"Esconder sempre os sentimentos",ok:false},{t:"Ficar sozinha sem contar a ninguém",ok:false}], exp:"A saúde mental é tão importante quanto a física. Partilhar sentimentos difíceis com um adulto de confiança é o primeiro passo para obter ajuda. Em Portugal, o psicólogo escolar pode ser um primeiro apoio." }
    ],
    protecao: [
      ...
      { q:"O que é o bullying e como pode ser prevenido?", a:[{t:"É comportamento agressivo repetido — previne-se com educação, empatia e denúncia",ok:true},{t:"É uma brincadeira normal entre crianças",ok:false},{t:"Só acontece em escolas grandes",ok:false}], exp:"O bullying é um comportamento agressivo intencional e repetido que causa sofrimento à vítima. Pode ser físico, verbal, social ou digital (ciberbullying). A prevenção passa pela educação para a empatia, pela criação de ambientes escolares seguros e pelo encorajamento à denúncia." },
      { q:"O que é o trabalho infantil e como viola os direitos das crianças?", a:[{t:"É o trabalho que prejudica a saúde, educação e desenvolvimento da criança",ok:true},{t:"É qualquer ajuda que uma criança dê em casa",ok:false},{t:"É apenas trabalho em fábricas",ok:false}], exp:"O artigo 32.º proíbe o trabalho infantil que interfira com a educação ou seja prejudicial para a saúde. Cerca de 160 milhões de crianças no mundo trabalham em condições de exploração — privadas da escola e de uma infância digna." },
      { q:"O que é a mutilação genital feminina e por que viola os direitos das raparigas?", a:[{t:"É uma prática violenta que causa danos físicos e psicológicos graves às raparigas",ok:true},{t:"É um ritual sem consequências para a saúde",ok:false},{t:"É permitida pela Convenção em certos contextos culturais",ok:false}], exp:"A mutilação genital feminina (MGF) é uma prática que viola os artigos 19.º, 24.º e 37.º da Convenção. Causa dores intensas, infecções e trauma psicológico. Afeta mais de 200 milhões de mulheres e raparigas no mundo. A UNICEF trabalha para a eliminar." },
      { q:"Que tipo de proteção garante o artigo 34.º da Convenção?", a:[{t:"Proteção contra exploração sexual e abuso sexual",ok:true},{t:"Proteção contra bullying escolar",ok:false},{t:"Proteção contra publicidade dirigida a crianças",ok:false}], exp:"O artigo 34.º obriga os Estados a proteger as crianças de todas as formas de exploração e abuso sexual. Isso inclui prevenir a indução de atividades sexuais ilegais, a prostituição infantil e a pornografia infantil." },
      { q:"O que é o tráfico de crianças e que artigo da Convenção o proíbe?", a:[{t:"É o recrutamento e transporte de crianças para exploração — artigo 35.º",ok:true},{t:"É a adoção internacional sem documentos adequados",ok:false},{t:"É a emigração de crianças para estudar no estrangeiro",ok:false}], exp:"O artigo 35.º obriga os Estados a adotar medidas para prevenir o rapto, a venda e o tráfico de crianças. O tráfico é uma forma grave de violação dos direitos humanos que afeta centenas de milhares de crianças por ano." },
      { q:"Quem pode contactar o número SOS Criança (116 111)?", a:[{t:"Qualquer pessoa — adultos, crianças ou jovens que suspeitem de risco",ok:true},{t:"Apenas os pais das crianças em risco",ok:false},{t:"Só assistentes sociais e professores",ok:false}], exp:"O 116 111 pode ser contactado por qualquer pessoa: uma criança que peça ajuda, um adulto que suspeite de maus tratos, um vizinho ou um professor. A linha é gratuita, confidencial e funciona 24 horas por dia, 7 dias por semana." },
      { q:"O que é o 'superior interesse da criança' no contexto da proteção?", a:[{t:"O princípio de que o bem-estar da criança deve orientar todas as decisões que a afetam",ok:true},{t:"O direito das crianças a tomar todas as decisões sozinhas",ok:false},{t:"A obrigação do Estado de separar sempre as crianças dos pais em caso de conflito",ok:false}], exp:"O 'superior interesse da criança' (artigo 3.º) é o princípio-chave: em qualquer decisão — judicial, administrativa ou familiar — o bem-estar da criança deve ser prioritário. Isto não significa que a criança decide tudo, mas que as decisões são tomadas a pensar no que é melhor para ela." }
    participacao: [
      ...
      { q:"O que é o Parlamento dos Jovens em Portugal?", a:[{t:"Uma iniciativa que permite a estudantes debaterem como deputados na Assembleia da República",ok:true},{t:"Um partido político para jovens",ok:false},{t:"Uma emissão de televisão sobre política para crianças",ok:false}], exp:"O Parlamento dos Jovens é um programa educativo que funciona em parceria com a Assembleia da República. Alunos do ensino básico e secundário debatem temas da atualidade no hemiciclo — o plenário do Parlamento — exercendo o direito à participação garantido pelo artigo 12.º da Convenção." },
      { q:"O que deve fazer uma escola para respeitar o direito à participação dos alunos?", a:[{t:"Criar assembleias de alunos, ouvir os seus representantes e considerar as suas propostas",ok:true},{t:"Deixar os alunos decidir o currículo escolar",ok:false},{t:"Dispensar os alunos das regras escolares",ok:false}], exp:"O artigo 12.º é concreto nas escolas: implica ter assembleias de turma e de escola, ter delegados com voz ativa, consultar os alunos antes de grandes decisões e explicar as razões quando as suas propostas não são aceites." },
      { q:"A partir de que idade podem as crianças exercer plenamente o direito à participação?", a:[{t:"Desde o nascimento, de forma progressiva conforme a maturidade",ok:true},{t:"Apenas a partir dos 14 anos",ok:false},{t:"Só depois dos 18 anos, com a maioridade",ok:false}], exp:"O artigo 12.º não fixa uma idade mínima — aplica-se a todas as crianças de acordo com a sua 'idade e maturidade'. Até os bebés comunicam necessidades. As crianças mais novas têm formas de participação adaptadas à sua fase de desenvolvimento." },
      { q:"O que é a 'consulta simbólica' de crianças e por que deve ser evitada?", a:[{t:"É fingir ouvir as crianças mas ignorar sempre a sua opinião — viola o artigo 12.º",ok:true},{t:"É uma forma adequada de envolver crianças pequenas",ok:false},{t:"É uma prática recomendada pela ONU para poupar tempo",ok:false}], exp:"A 'consulta simbólica' acontece quando se pede a opinião das crianças mas nunca se a considera. O artigo 12.º exige que a participação seja genuína: as crianças devem ver as suas perspetivas consideradas e, quando não seguidas, devem receber explicações." },
      { q:"Como podem as crianças participar nas decisões sobre o ambiente e as alterações climáticas?", a:[{t:"Através de protestos pacíficos, petições, projetos escolares e participação cívica",ok:true},{t:"Não podem — é uma matéria apenas para adultos e governos",ok:false},{t:"Só se forem filhas de políticos ou cientistas",ok:false}], exp:"A Convenção e os ODS reconhecem o papel das crianças como agentes de mudança climática. Exemplos como Greta Thunberg mostram que as crianças podem influenciar a agenda global. Em Portugal, muitas escolas participam em projetos Eco-Escolas e organizações como a Quercus têm programas juvenis." }
    ,
      { q:"O que é empatia?", a:[{t:"A capacidade de sentir e compreender o que o outro sente",ok:true},{t:"Ignorar completamente os outros",ok:false},{t:"Competir sempre para ser o melhor",ok:false}], exp:"A empatia — colocarmo-nos no lugar do outro — é fundamental para a convivência respeitosa. A CDC promove uma educação que desenvolve o respeito e a compreensão pelos outros (artigo 29.º)." },
      { q:"Como se resolve um conflito entre amigos de forma saudável?", a:[{t:"Com diálogo e compreensão mútua",ok:true},{t:"Com violência",ok:false},{t:"Ignorando o problema para sempre",ok:false}], exp:"O diálogo e a compreensão mútua são as ferramentas mais eficazes para resolver conflitos. As crianças que aprendem a dialogar desde cedo desenvolvem competências essenciais para a cidadania democrática." },
      { q:"O que ajuda a construir uma boa amizade?", a:[{t:"Honestidade, respeito e carinho",ok:true},{t:"Mentiras e guardar segredos prejudiciais",ok:false},{t:"Competição constante",ok:false}], exp:"A amizade genuína baseia-se em honestidade, respeito mútuo e carinho. Estas são também as bases de uma sociedade democrática — valores que a educação para a cidadania deve transmitir desde cedo." },
      { q:"As crianças de culturas diferentes podem ser amigas?", a:[{t:"Sim, a diversidade enriquece as amizades",ok:true},{t:"Não, é muito difícil sem a mesma cultura",ok:false},{t:"Só se falarem exatamente a mesma língua",ok:false}], exp:"A amizade não tem fronteiras. A diversidade cultural enriquece as amizades e ajuda as crianças a desenvolver empatia e respeito pelo outro — competências fundamentais para a cidadania global." }
    ],
    futuro: [
      ...
      { q:"Qual é o ODS relacionado com a saúde e bem-estar?", a:[{t:"ODS 3 — Saúde de Qualidade",ok:true},{t:"ODS 2 — Acabar com a Fome",ok:false},{t:"ODS 6 — Água Potável e Saneamento",ok:false}], exp:"O ODS 3 visa garantir saúde e bem-estar para todos até 2030: reduzir a mortalidade infantil, acabar com epidemias, garantir saúde mental e cobertura universal de cuidados de saúde." },
      { q:"O que é a 'Agenda 2030'?", a:[{t:"O plano da ONU com 17 objetivos para um mundo melhor até 2030",ok:true},{t:"Um calendário de reuniões do G20 até 2030",ok:false},{t:"Um programa europeu de financiamento de escolas",ok:false}], exp:"A Agenda 2030 para o Desenvolvimento Sustentável é um compromisso de 193 países adotado em 2015. Inclui 17 ODS e 169 metas. É um plano para 'não deixar ninguém para trás', com foco especial nas crianças e nos mais vulneráveis." },
      { q:"Que ODS trata especificamente das desigualdades entre países e dentro deles?", a:[{t:"ODS 10 — Reduzir as Desigualdades",ok:true},{t:"ODS 16 — Paz e Justiça",ok:false},{t:"ODS 17 — Parcerias para os Objetivos",ok:false}], exp:"O ODS 10 visa reduzir as desigualdades de rendimento e promover a inclusão social, económica e política de todos. As crianças de famílias mais pobres têm menos acesso à educação, saúde e alimentação — um ciclo de desigualdade que o ODS 10 pretende quebrar." },
      { q:"Como estão os ODS relacionados com os direitos da Convenção dos Direitos da Criança?", a:[{t:"São complementares — os ODS operacionalizam os direitos da Convenção com metas mensuráveis",ok:true},{t:"São documentos independentes sem relação entre si",ok:false},{t:"Os ODS substituíram a Convenção dos Direitos da Criança",ok:false}], exp:"A Convenção estabelece os direitos das crianças; os ODS fornecem as metas e indicadores para os concretizar. Por exemplo, o direito à educação (art. 28.º da CDC) liga-se diretamente ao ODS 4. Os dois documentos reforçam-se mutuamente." }
    ,
      { q:"O que é necessário para realizar um sonho?", a:[{t:"Esforço, perseverança e apoio",ok:true},{t:"Sorte apenas",ok:false},{t:"Muito dinheiro desde criança",ok:false}], exp:"Realizar um sonho exige determinação, trabalho consistente e, muitas vezes, o apoio de pessoas que acreditam em nós. A CDC reconhece o direito das crianças a desenvolver ao máximo o seu potencial." },
      { q:"Malala Yousafzai ficou famosa por lutar por qual direito?", a:[{t:"Direito à educação das raparigas",ok:true},{t:"Direito ao voto",ok:false},{t:"Direito à alimentação",ok:false}], exp:"Malala lutou contra a proibição taliban da educação feminina no Paquistão e tornou-se a mais jovem Nobel da Paz com 17 anos. A sua história inspira crianças de todo o mundo a defender os seus direitos." },
      { q:"O que é a perseverança?", a:[{t:"Continuar a tentar mesmo quando é difícil",ok:true},{t:"Desistir ao primeiro obstáculo",ok:false},{t:"Copiar pelos outros",ok:false}], exp:"A perseverança é a capacidade de continuar a avançar face às dificuldades. É uma das competências mais importantes que as crianças podem desenvolver — base do sucesso a longo prazo." },
      { q:"Por que os sonhos das crianças são importantes?", a:[{t:"Motivam-nas a aprender, crescer e mudar o mundo",ok:true},{t:"Não são importantes, são só fantasias",ok:false},{t:"Só interessam aos pais",ok:false}], exp:"Os sonhos das crianças têm valor real: motivam a aprendizagem, desenvolvem a criatividade e, quando perseguidos, podem transformar o mundo. A ONU reconhece o direito das crianças a participar e expressar a sua visão do futuro." }
    ],
    unicef: [
      ...
      { q:"Como se financia a UNICEF?", a:[{t:"Através de contribuições voluntárias de governos, empresas e cidadãos",ok:true},{t:"É financiada pelo imposto sobre o valor acrescentado de todos os países",ok:false},{t:"Através de taxas cobradas às crianças beneficiadas",ok:false}], exp:"A UNICEF não recebe financiamento obrigatório da ONU — depende inteiramente de donativos voluntários. Os governos são os maiores contribuintes, mas qualquer pessoa pode fazer uma doação. Em Portugal, o Comité Português da UNICEF angaria fundos junto de empresas e particulares." },
      { q:"O que é o 'Children's Rights and Business Principles' da UNICEF?", a:[{t:"Um conjunto de orientações para que as empresas respeitem os direitos das crianças",ok:true},{t:"Um programa de emprego infantil em empresas tecnológicas",ok:false},{t:"Um banco criado pela UNICEF para financiar escolas",ok:false}], exp:"Em parceria com a ONU Global Compact e Save the Children, a UNICEF publicou os 'Princípios Empresariais e Direitos da Criança', que orientam as empresas a evitar prejudicar crianças nas suas operações e a contribuir para o seu bem-estar." },
      { q:"Qual é a missão principal da UNICEF no campo da educação em emergências?", a:[{t:"Garantir que as crianças continuem a estudar mesmo durante guerras e desastres",ok:true},{t:"Substituir os professores por robôs nas zonas de conflito",ok:false},{t:"Repatriar as crianças para os países de origem para estudarem",ok:false}], exp:"A UNICEF tem um programa de 'Educação em Emergências' que instala escolas temporárias ('tendas escolares'), fornece materiais e forma professores em zonas de guerra ou após catástrofes. O objetivo é garantir que nenhuma criança perca a escola por culpa de um conflito." },
      { q:"Que programa da UNICEF fornece vacinas a metade das crianças do mundo?", a:[{t:"O programa de imunização da UNICEF em parceria com a OMS e a GAVI",ok:true},{t:"O programa 'Escola Saudável' da UNICEF",ok:false},{t:"O Fundo Global contra a SIDA, Tuberculose e Malária",ok:false}], exp:"A UNICEF, em parceria com a OMS e a GAVI (Aliança das Vacinas), fornece vacinas a cerca de metade das crianças do mundo. As campanhas de vacinação salvam milhões de vidas por ano e erradicaram doenças como a varíola." }
    ,
      { q:"O que é a ONU?", a:[{t:"Organização das Nações Unidas, para a paz e cooperação global",ok:true},{t:"Uma organização desportiva internacional",ok:false},{t:"Uma empresa privada multinacional",ok:false}], exp:"A ONU foi fundada em 1945 para promover a paz, a segurança e a cooperação entre países. É a organização-mãe da UNICEF, da OMS e de outras agências que protegem os direitos das crianças." },
      { q:"Qual organização protege especialmente os refugiados?", a:[{t:"ACNUR — Alto Comissariado da ONU para Refugiados",ok:true},{t:"FIFA",ok:false},{t:"NASA",ok:false}], exp:"O ACNUR trabalha em mais de 130 países para proteger refugiados, apátridas e pessoas deslocadas. Em parceria com a UNICEF, garante que as crianças refugiadas têm acesso à educação, saúde e proteção." },
      { q:"O que é a cidadania global?", a:[{t:"Sentido de responsabilidade pelo bem de toda a humanidade",ok:true},{t:"Ter passaporte de todos os países",ok:false},{t:"Viajar para muitos países",ok:false}], exp:"A cidadania global é a consciência de que pertencemos a uma comunidade humana partilhada e que as nossas ações têm impacto nos outros, incluindo em crianças de todo o mundo." }
    ],
    identidade: [
      ...
      { q:"O que inclui a identidade de uma criança segundo a Convenção?", a:[{t:"Nome, nacionalidade e relações familiares",ok:true},{t:"Apenas o nome e a data de nascimento",ok:false},{t:"Só a religião e a língua materna",ok:false}], exp:"Segundo o artigo 8.º da Convenção, a identidade de uma criança inclui o seu nome, a sua nacionalidade e os seus vínculos familiares. Os Estados devem respeitar estes elementos e, se forem removidos ilegalmente, ajudar a criança a recuperá-los." },
      { q:"Em que prazo deve ser registada uma criança em Portugal?", a:[{t:"Nos primeiros 20 dias úteis após o nascimento",ok:true},{t:"No primeiro aniversário",ok:false},{t:"Apenas quando entrar na escola",ok:false}], exp:"Em Portugal, o registo de nascimento deve ser feito nos primeiros 20 dias úteis após o nascimento. É gratuito e pode ser feito na maternidade, no registo civil ou online. Um registo tardio pode originar complicações legais." },
      { q:"O que é a 'pegada digital' e como pode afetar a identidade das crianças?", a:[{t:"São os dados e informações que existem online sobre uma pessoa — podem afetá-la toda a vida",ok:true},{t:"É um programa de educação digital para crianças",ok:false},{t:"É o historial de pesquisas na internet, sem consequências",ok:false}], exp:"A pegada digital começa quando os pais partilham fotos de bebés nas redes sociais. Cada publicação, comentário e interação online constrói uma identidade digital permanente. O artigo 16.º (privacidade) e o 'direito ao esquecimento' do RGPD protegem as crianças de uma pegada digital indesejada." },
      { q:"Que situação viola o direito à identidade de uma criança?", a:[{t:"Recusar o registo de nascimento por motivos étnicos ou religiosos",ok:true},{t:"Escolher o nome da criança antes do nascimento",ok:false},{t:"Registar a criança com dois apelidos dos pais",ok:false}], exp:"O artigo 2.º (não discriminação) combinado com o artigo 7.º (direito à identidade) proíbe que o registo seja recusado por motivos de raça, etnia, religião ou origem. Qualquer criança, independentemente da sua origem, tem o direito incondicional a ser registada." }
    ],
    familia: [
      ...
      { q:"O que é o 'acolhimento familiar' em Portugal?", a:[{t:"Uma medida em que uma criança em risco vive temporariamente com uma família de acolhimento",ok:true},{t:"Um programa de visitas de crianças a famílias do campo",ok:false},{t:"A adoção permanente de uma criança por uma nova família",ok:false}], exp:"O acolhimento familiar em Portugal é uma medida de promoção e proteção prevista na Lei de Proteção de Crianças e Jovens em Perigo. Uma família de acolhimento (não a família biológica) presta cuidados temporários a uma criança em risco, enquanto se trabalha para a reunificação familiar ou se prepara a adoção." },
      { q:"Que direito tem uma criança quando os seus pais se divorciam?", a:[{t:"O direito a manter contacto com ambos os pais, salvo se isso prejudicar o seu bem-estar",ok:true},{t:"O direito de escolher sempre ficar com a mãe",ok:false},{t:"Perde automaticamente o direito de ver o pai com quem não vive",ok:false}], exp:"O artigo 9.º da Convenção garante que a criança cujos pais vivem separados tem o direito de manter contacto e relações pessoais com ambos os pais, a menos que isso seja contrário ao seu superior interesse. Em Portugal, o regime de residência alternada tem crescido." },
      { q:"O que é o 'apadrinhamento civil' em Portugal?", a:[{t:"É uma relação de proximidade entre um adulto e uma criança em risco, com apoio a longo prazo",ok:true},{t:"É um ritual religioso de batismo",ok:false},{t:"É a adoção de uma criança por um padeiro",ok:false}], exp:"O apadrinhamento civil é uma figura legal portuguesa criada em 2011. Permite que um adulto (o padrinho) estabeleça uma relação estável e duradoura com uma criança que vive numa instituição, garantindo-lhe afeto, apoio e um adulto de referência — sem substituir a família ou implicar adoção." },
      { q:"Como pode uma criança expressar os seus sentimentos sobre a situação familiar no tribunal?", a:[{t:"Através do seu representante legal ou sendo ouvida pelo juiz, conforme a maturidade",ok:true},{t:"Não pode — as crianças não têm voz em processos judiciais",ok:false},{t:"Apenas através de carta enviada ao Ministério da Justiça",ok:false}], exp:"O artigo 12.º garante que a criança tem o direito de ser ouvida em processos que a afetem, incluindo divórcios, processos de adoção e medidas de proteção. Em Portugal, o Código Civil e a LPCJP preveem a audição de crianças a partir dos 12 anos (e mais novas se a maturidade o justificar)." }
    ],
    refugiados: [
      ...
      { q:"Qual é a diferença entre 'refugiado' e 'migrante'?", a:[{t:"O refugiado foge de perseguição ou guerra; o migrante desloca-se principalmente por razões económicas",ok:true},{t:"São exatamente a mesma coisa",ok:false},{t:"O migrante tem mais direitos do que o refugiado",ok:false}], exp:"Um refugiado foge do seu país por fundado receio de perseguição — por causa da raça, religião, nacionalidade, grupo social ou opinião política. Um migrante desloca-se por vontade própria, geralmente por razões económicas. Ambos têm direitos, mas os refugiados têm proteção internacional específica." },
      { q:"O que é o 'princípio de não repulsão' (non-refoulement) no direito dos refugiados?", a:[{t:"Um princípio que proíbe devolver refugiados a países onde a sua vida está em risco",ok:true},{t:"Um princípio que permite aos países recusar todos os refugiados",ok:false},{t:"Uma regra sobre a ordem de chegada nos centros de acolhimento",ok:false}], exp:"O princípio de non-refoulement é a pedra angular do direito dos refugiados: nenhum país pode devolver um refugiado a um território onde enfrente perseguição, tortura ou morte. Está consagrado na Convenção de Genebra de 1951 e na Convenção dos Direitos da Criança." },
      { q:"Que impacto tem a guerra na educação das crianças refugiadas?", a:[{t:"Muitas perdem anos de escola, o que afeta profundamente o seu futuro",ok:true},{t:"As crianças refugiadas têm sempre acesso a escolas melhores nos países de acolhimento",ok:false},{t:"A guerra não afeta a educação, pois as escolas estão sempre protegidas",ok:false}], exp:"Segundo a UNICEF, em zonas de conflito, as crianças têm 30% mais probabilidade de estar fora da escola. Cada ano perdido afeta o desenvolvimento cognitivo e as perspetivas de futuro. A UNICEF investe em escolas seguras, aprendizagem acelerada e apoio psicossocial para crianças em contexto de crise." },
      { q:"Como pode Portugal acolher crianças refugiadas?", a:[{t:"Através do programa de recolocação europeu, proteção temporária e apoio à integração",ok:true},{t:"Portugal não aceita crianças refugiadas por lei",ok:false},{t:"Apenas se acompanhadas de adultos com visa de trabalho válido",ok:false}], exp:"Portugal participa nos programas europeus de recolocação de refugiados e tem um sistema de proteção para menores não acompanhados, gerido pelo SEF (Serviço de Estrangeiros e Fronteiras) e o ACM (Alto Comissariado para as Migrações). As crianças refugiadas têm acesso à escola, saúde e serviços de apoio psicossocial." }
    ],
    trabalho: [
      ...
      { q:"O que são as 'piores formas de trabalho infantil' segundo a OIT?", a:[{t:"Escravidão, tráfico, prostituição, trabalho em minas e conflitos armados",ok:true},{t:"Apenas o trabalho em fábricas sem ventilação",ok:false},{t:"Qualquer trabalho remunerado antes dos 18 anos",ok:false}], exp:"A Convenção n.º 182 da OIT define as piores formas como: escravidão e práticas similares, tráfico, servidão por dívida, prostituição e pornografia infantil, recrutamento para conflitos armados e trabalho que prejudique gravemente a saúde ou a segurança." },
      { q:"Como o trabalho infantil afeta o futuro das crianças?", a:[{t:"Impede o acesso à educação e perpetua ciclos de pobreza",ok:true},{t:"Dá-lhes experiência profissional valiosa",ok:false},{t:"Não tem impacto se a criança também frequentar a escola",ok:false}], exp:"O trabalho infantil é um ciclo vicioso: a criança que trabalha em vez de estudar fica sem qualificações, tornando-se adulta pobre que provavelmente também mandará os filhos trabalhar. A educação é a chave para romper este ciclo — por isso o artigo 32.º liga explicitamente a proibição do trabalho infantil ao direito à escola." },
      { q:"Em que continente está concentrada a maior percentagem de trabalho infantil?", a:[{t:"África — especialmente na África Subsariana",ok:true},{t:"Europa",ok:false},{t:"América do Norte",ok:false}], exp:"A África Subsariana concentra cerca de 23% de todas as crianças em trabalho infantil — a maior proporção de qualquer região do mundo. Conflitos, pobreza extrema e falta de acesso à educação são os principais fatores." },
      { q:"O que pode um consumidor fazer para ajudar a combater o trabalho infantil?", a:[{t:"Escolher produtos com certificação de comércio justo e informar-se sobre as cadeias de produção",ok:true},{t:"Nada — é um problema que só os governos podem resolver",ok:false},{t:"Boicotar todos os produtos fabricados fora da Europa",ok:false}], exp:"Os consumidores têm poder: ao escolher produtos com certificação Fairtrade ou de empresas com políticas de cadeia de fornecimento responsável, pressionam o mercado. Organizações como a UNICEF e a OIT promovem o consumo responsável como ferramenta de combate ao trabalho infantil." }
    ],
    expressao: [
      ...
      { q:"O que é o 'discurso de ódio' e por que é problemático para as crianças?", a:[{t:"É expressão que incita ao ódio ou discriminação — prejudica a dignidade e a segurança",ok:true},{t:"É apenas crítica forte em debates escolares",ok:false},{t:"É um direito protegido pela liberdade de expressão sem exceções",ok:false}], exp:"O discurso de ódio — mensagens que atacam pessoas por raça, religião, orientação sexual ou outra característica — viola o artigo 2.º (não discriminação) e o artigo 16.º (dignidade). A liberdade de expressão não protege discurso que incita à violência ou discriminação." },
      { q:"Qual é o papel das artes na expressão das crianças?", a:[{t:"A arte é um meio essencial de expressão, criatividade e desenvolvimento emocional",ok:true},{t:"As artes são apenas atividades de lazer sem impacto no desenvolvimento",ok:false},{t:"Só as crianças com talento artístico têm direito às artes",ok:false}], exp:"O artigo 13.º protege a expressão através da arte — desenho, música, dança, teatro, escrita. A arte permite que as crianças processem emoções, comuniquem experiências e desenvolvam criatividade. O artigo 29.º inclui o desenvolvimento artístico nos objetivos da educação." },
      { q:"O que é o 'jornalismo escolar' e que direitos protege?", a:[{t:"É um jornal ou blogue feito por alunos que exercita a expressão e a cidadania",ok:true},{t:"É a televisão da escola, gerida apenas por professores",ok:false},{t:"É um projeto opcional apenas para escolas com recursos",ok:false}], exp:"O jornalismo escolar é uma prática pedagógica reconhecida que exercita os artigos 13.º (expressão), 17.º (acesso à informação) e 12.º (participação). Aprender a produzir notícias responsáveis ensina às crianças a importância da verdade, do rigor e da liberdade de imprensa." },
      { q:"Como pode a expressão artística ajudar crianças que sofreram trauma?", a:[{t:"Através de atividades criativas que permitem processar emoções de forma segura",ok:true},{t:"A arte não tem impacto demonstrado na saúde mental",ok:false},{t:"Só ajuda crianças com formação artística formal",ok:false}], exp:"A arteterapia — uso de atividades artísticas como ferramenta terapêutica — é amplamente reconhecida na psicologia infantil. Pintura, teatro, música e escrita criativa ajudam as crianças a expressar sentimentos que não conseguem verbalizar, processar traumas e fortalecer a resiliência." }
    ],
    privacidade: [
      ...
      { q:"O que são dados pessoais e por que são importantes proteger?", a:[{t:"São informações que identificam uma pessoa, como nome, morada ou rosto",ok:true},{t:"São apenas números bancários e palavras-passe",ok:false},{t:"São só informações partilhadas voluntariamente",ok:false}], exp:"Dados pessoais incluem: nome, morada, data de nascimento, número de telemóvel, fotografia, localização GPS e até endereço IP. O RGPD protege estes dados porque, nas mãos erradas, podem ser usados para perseguição, fraude, roubo de identidade ou assédio." },
      { q:"O que é o 'controlo parental' e qual é o seu objetivo?", a:[{t:"Ferramentas digitais que permitem aos pais gerir o que os filhos veem e fazem online",ok:true},{t:"Uma forma de espiar as crianças ilegalmente",ok:false},{t:"Um programa obrigatório instalado pelo governo nos telemóveis",ok:false}], exp:"O controlo parental são ferramentas — integradas em dispositivos ou instaladas pelos pais — que filtram conteúdos inadequados, limitam o tempo de ecrã e monitorizam a atividade online das crianças mais novas. É uma medida de proteção, não de punição, compatível com o artigo 16.º (privacidade) quando usada de forma proporcional." },
      { q:"O que é a 'pegada digital' e como pode afetar a privacidade?", a:[{t:"É o conjunto de dados deixados online — podem ser usados para identificar ou rastrear alguém",ok:true},{t:"É um programa de treino digital nas escolas",ok:false},{t:"É o histórico de downloads de música e filmes",ok:false}], exp:"Cada ação online — comentários, gostos, fotos, pesquisas — deixa uma pegada digital permanente. Esta informação pode ser usada por empresas para publicidade, por algoritmos para influenciar comportamentos ou por pessoas mal-intencionadas para assédio. Ensinar as crianças a gerir a sua pegada digital é essencial." },
      { q:"Que entidade em Portugal fiscaliza o cumprimento do RGPD e protege os dados das crianças?", a:[{t:"A CNPD — Comissão Nacional de Proteção de Dados",ok:true},{t:"A GNR — Guarda Nacional Republicana",ok:false},{t:"O Ministério da Educação",ok:false}], exp:"A CNPD (Comissão Nacional de Proteção de Dados) é a autoridade portuguesa independente que fiscaliza o cumprimento do RGPD. Pode investigar empresas e plataformas que violem os dados de menores, aplicar multas e publicar orientações para proteger as crianças no espaço digital." }
    ],
    cultura: [
      ...
      { q:"O que é o 'racismo' e como viola os direitos das crianças?", a:[{t:"É discriminação com base na raça ou etnia — viola o artigo 2.º (não discriminação)",ok:true},{t:"É ter opiniões diferentes sobre culturas",ok:false},{t:"É apenas a violência física contra pessoas de outras origens",ok:false}], exp:"O artigo 2.º da Convenção proíbe qualquer discriminação com base na raça, cor ou origem étnica. O racismo pode manifestar-se de forma direta (insultos, violência) ou estrutural (acesso desigual à educação, saúde). As escolas têm obrigação de combater ativamente o racismo e promover o respeito pela diversidade." },
      { q:"O que é o 'patrimônio imaterial' e como é protegido?", a:[{t:"São tradições vivas como a música, a dança, os rituais e o artesanato de um povo",ok:true},{t:"São apenas monumentos históricos e museus",ok:false},{t:"É o conjunto de leis antigas de um país",ok:false}], exp:"A UNESCO define o Património Imaterial como as práticas, representações, expressões, conhecimentos e técnicas que as comunidades reconhecem como parte do seu patrimônio cultural vivo: o Fado, o artesanato do Alentejo, as danças populares. Portugal tem vários elementos inscritos na lista da UNESCO." },
      { q:"Como pode a escola valorizar a diversidade cultural dos seus alunos?", a:[{t:"Integrando as diferentes culturas nos currículos e celebrando as tradições de todos",ok:true},{t:"Pedindo aos alunos estrangeiros que não usem a sua língua na escola",ok:false},{t:"Separando os alunos por grupos culturais",ok:false}], exp:"Uma escola que valoriza a diversidade inclui as diferentes culturas nos currículos, celebra datas importantes para todas as comunidades presentes, usa recursos em múltiplas línguas e treina professores para a educação intercultural. Isto implementa concretamente o artigo 29.º (objetivos da educação) e o artigo 30.º (direito à cultura)." },
      { q:"O que é a 'interculturalidade' e como se diferencia da 'multiculturalidade'?", a:[{t:"Interculturalidade é o diálogo e enriquecimento mútuo entre culturas, não só a sua coexistência",ok:true},{t:"São dois conceitos idênticos",ok:false},{t:"A interculturalidade significa que uma cultura é melhor do que outra",ok:false}], exp:"Multiculturalidade é a coexistência de várias culturas numa sociedade. Interculturalidade vai mais longe: é o diálogo ativo, o intercâmbio e o enriquecimento mútuo entre culturas. A UNESCO e o Conselho da Europa promovem a interculturalidade como base para a paz e a coesão social nas sociedades diversas." }
    ],
    deficiencia: [
      ...
      { q:"O que é o Plano de Educação Individual (PEI) em Portugal?", a:[{t:"Um plano personalizado para alunos com necessidades especiais que adapta o currículo e o apoio",ok:true},{t:"Um programa de reforço escolar para todos os alunos",ok:false},{t:"Um plano obrigatório para alunos com mau comportamento",ok:false}], exp:"O PEI (ou medidas do Decreto-Lei 54/2018) é um conjunto de medidas educativas adaptadas às necessidades específicas de cada aluno com NEE (Necessidades Educativas Especiais). Pode incluir adaptações curriculares, apoio de professores de educação especial e tecnologias de apoio." },
      { q:"O que é a 'linguagem gestual portuguesa' e a quem é essencial?", a:[{t:"É a língua natural das pessoas surdas em Portugal, reconhecida constitucionalmente",ok:true},{t:"É um sistema de sinais usado pelos árbitros de futebol",ok:false},{t:"É uma língua estrangeira opcional estudada em escolas bilingues",ok:false}], exp:"A Língua Gestual Portuguesa (LGP) é a língua materna das pessoas surdas em Portugal. A Constituição Portuguesa reconhece-a como língua oficial. As crianças surdas têm o direito a ser educadas em LGP — um direito cultural e linguístico protegido pelos artigos 23.º e 30.º da CDC." },
      { q:"O que é o sistema Braille e para que é usado?", a:[{t:"É um sistema de escrita em relevo para pessoas cegas ou com baixa visão",ok:true},{t:"É um tipo de caligrafia para crianças com dificuldades motoras",ok:false},{t:"É um método de leitura rápida para crianças sobredotadas",ok:false}], exp:"O Braille foi criado por Louis Braille (1809-1852) e consiste em pontos em relevo que representam letras, números e símbolos musicais. É a principal forma de leitura e escrita independente para pessoas cegas. Em Portugal, os materiais escolares em Braille são produzidos pelo Ministério da Educação para alunos com deficiência visual." },
      { q:"O que é a 'Convenção da ONU sobre os Direitos das Pessoas com Deficiência' (CRPD)?", a:[{t:"Um tratado de 2006 que reforça os direitos das pessoas com deficiência a nível global",ok:true},{t:"Uma lei europeia sobre pensões de invalidez",ok:false},{t:"Um programa de emprego para adultos com deficiência",ok:false}], exp:"A CRPD foi adotada pela ONU em 2006 e ratificada por Portugal em 2009. Complementa a CDC para adultos e crianças com deficiência, reforçando os direitos à vida independente, à educação inclusiva, ao trabalho digno e à participação política. O artigo 23.º da CDC e a CRPD formam o quadro legal de proteção das crianças com deficiência." }
    ],
    ambiente: [
      ...
      { q:"O que é a 'Greve Climática Escolar' iniciada por Greta Thunberg?", a:[{t:"Um movimento global de jovens que protestam pela ação climática",ok:true},{t:"Um programa de reciclagem organizado por escolas suecas",ok:false},{t:"Uma disciplina obrigatória sobre ambiente em escolas europeias",ok:false}], exp:"Em 2018, Greta Thunberg iniciou a Greve Climática Escolar, sentando-se em frente ao parlamento sueco. O movimento 'Fridays for Future' espalhou-se pelo mundo, com milhões de jovens a exigir ação climática urgente. É um exemplo do artigo 12.º (participação) e 13.º (expressão) da Convenção em ação." },
      { q:"O que são energias renováveis e por que são importantes para as crianças do futuro?", a:[{t:"São energias como o sol, o vento e a água, que não se esgotam e não poluem",ok:true},{t:"São energias obtidas do petróleo reciclado",ok:false},{t:"São apenas energia nuclear e hidroelétrica",ok:false}], exp:"As energias renováveis (solar, eólica, hídrica, geotérmica) são essenciais para reduzir as emissões de CO₂. Portugal é um dos líderes europeus em energias renováveis — em 2023, produziu mais de 60% da sua eletricidade a partir de fontes renováveis. Uma transição energética bem feita protege o futuro das crianças de hoje." },
      { q:"O que é a 'Convenção das Nações Unidas sobre as Alterações Climáticas' (UNFCCC)?", a:[{t:"O tratado internacional que orienta os países a reduzir emissões de gases de estufa",ok:true},{t:"Uma lei europeia sobre reciclagem",ok:false},{t:"Um programa da UNICEF para plantar árvores",ok:false}], exp:"A UNFCCC (1992) e o Acordo de Paris (2015) são os principais tratados para combater as alterações climáticas. O Acordo de Paris compromete os países a limitar o aquecimento a 1,5ºC. Portugal ratificou ambos. As crianças de hoje serão as mais afetadas se estes compromissos não forem cumpridos." }
    ,
      { q:"O que significa '3Rs' do ambiente?", a:[{t:"Reduzir, Reutilizar, Reciclar",ok:true},{t:"Rir, Relaxar, Repousar",ok:false},{t:"Rego, Rio, Riacho",ok:false}], exp:"Os 3Rs são a base da sustentabilidade: Reduzir o consumo, Reutilizar o que ainda serve e Reciclar o que não pode ser reutilizado. Cada criança pode praticar os 3Rs no dia a dia." },
      { q:"Qual gesto poupa mais água em casa?", a:[{t:"Fechar a torneira enquanto se lava os dentes",ok:true},{t:"Deixar a torneira sempre aberta",ok:false},{t:"Encher a banheira todos os dias",ok:false}], exp:"Fechar a torneira enquanto se escovam os dentes poupa até 12 litros de água por minuto! Pequenos gestos diários, multiplicados por milhões de pessoas, fazem uma enorme diferença." },
      { q:"Por que devemos separar o lixo em casa?", a:[{t:"Para facilitar a reciclagem e reduzir o desperdício",ok:true},{t:"É inútil — o lixo vai todo para o mesmo sítio",ok:false},{t:"Apenas por questões estéticas",ok:false}], exp:"A separação do lixo permite reciclar papel, vidro, plástico e metal — poupando energia, recursos naturais e reduzindo a quantidade de resíduos em aterro." },
      { q:"O que é compostagem?", a:[{t:"Transformar resíduos orgânicos em adubo natural",ok:true},{t:"Um tipo de dança tradicional",ok:false},{t:"Uma técnica de pintura artística",ok:false}], exp:"A compostagem transforma restos de alimentos em adubo natural rico em nutrientes. É uma forma de fechar o ciclo natural — os resíduos voltam à terra como alimento para as plantas." }
    ],
    digital: [
      ...
      { q:"O que é o 'tempo de ecrã' e por que deve ser gerido pelas famílias?", a:[{t:"É o tempo passado em dispositivos digitais — deve ser equilibrado com outras atividades",ok:true},{t:"É uma punição em que as crianças não podem usar a internet",ok:false},{t:"É apenas o tempo passado a ver televisão",ok:false}], exp:"O tempo de ecrã excessivo pode afetar o sono, a concentração e o desenvolvimento social das crianças. A OMS recomenda que crianças até 5 anos não usem ecrãs mais de 1h por dia (exceto videochamadas). Equilibrar o tempo digital com exercício físico, leitura e interação social é essencial para o bem-estar." },
      { q:"Qual é o comentário geral da ONU que reconhece os direitos das crianças no espaço digital?", a:[{t:"Comentário Geral n.º 25, de 2021",ok:true},{t:"Declaração Digital de 2015",ok:false},{t:"Protocolo Internet da ONU de 2010",ok:false}], exp:"Em março de 2021, o Comité dos Direitos da Criança da ONU publicou o Comentário Geral n.º 25 sobre os direitos das crianças no ambiente digital. É o primeiro documento oficial que afirma explicitamente que todos os 54 artigos da Convenção de 1989 se aplicam também ao mundo online." }
    ]
  };
  ...
  const LEVELS = [
    {
      // NÍVEL 1 — Fácil: plataformas largas, poucos vilões, sem trampolins obrigatórios
      name: "Nível 1 — O Dia da Criança",
      theme:0, quizTheme:"historia", worldW:2400,
      spawn:{x:120,y:460}, doorX:2180,
      platforms:[
        // Plataforma de arranque larga
        {x:400,y:520,w:800,h:28},
        // Ilha 1
        {x:700,y:430,w:260,h:22},
        // Ilha 2 — ligeiramente mais alta, gap 180px
        {x:1060,y:370,w:260,h:22},
        // Ilha 3 — desce um pouco
        {x:1420,y:430,w:260,h:22},
        // Plataforma final larga com portal
        {x:2000,y:520,w:760,h:28}
      ],
      items:[
        {x:700,y:380,kind:"medalha"},
        {x:1060,y:320,kind:"estrela"},
        {x:1420,y:380,kind:"brinquedo"}
      ],
      malwares:[
        {x:800,y:480,vx:0,pattern:"mini"},
        {x:1650,y:480,vx:-120,pattern:"patrol"}
      ]
    },
    {
      // NÍVEL 2 — Introduz trampolim, ritmo crescente
      name: "Nível 2 — Os Direitos das Crianças",
      theme:1, quizTheme:"convencao", worldW:2600,
      spawn:{x:120,y:460}, doorX:2380,
      platforms:[
        {x:400,y:520,w:800,h:28},
        {x:720,y:440,w:240,h:22},
        {x:1080,y:380,w:240,h:22},
        // vão grande — trampolim assiste mas salto normal também chega
        {x:1520,y:440,w:240,h:22},
        {x:1880,y:380,w:240,h:22},
        {x:2200,y:520,w:760,h:28}
      ],
      items:[
        {x:720,y:390,kind:"balao"},
        {x:1080,y:330,kind:"estrela"},
        {x:1520,y:390,kind:"duplosalto"},
        {x:1880,y:330,kind:"medalha"}
      ],
      trampolines:[{x:1300,y:462}],
      malwares:[
        {x:820,y:480,vx:0,pattern:"mini"},
        {x:1200,y:480,vx:-130,pattern:"patrol"},
        {x:1980,y:480,vx:130,pattern:"patrol"}
      ]
    },
    {
      // NÍVEL 3 — Layout em escadas, vida extra escondida
      name: "Nível 3 — O Direito ao Brincar",
      theme:2, quizTheme:"brincar", worldW:2800,
      spawn:{x:120,y:460}, doorX:2580,
      platforms:[
        {x:400,y:520,w:800,h:28},
        // Escada de subida
        {x:720,y:450,w:240,h:22},
        {x:1000,y:390,w:240,h:22},
        {x:1280,y:330,w:240,h:22},
        // Escada de descida
        {x:1560,y:390,w:240,h:22},
        {x:1840,y:450,w:240,h:22},
        // Plataforma final
        {x:2400,y:520,w:760,h:28}
      ],
      items:[
        {x:720,y:400,kind:"balao"},
        {x:1000,y:340,kind:"duplosalto"},
        {x:1280,y:280,kind:"estrela"},
        {x:1560,y:340,kind:"brinquedo"},
        {x:400,y:470,kind:"heart"}
      ],
      trampolines:[{x:2080,y:462}],
      malwares:[
        {x:850,y:480,vx:0,pattern:"mini"},
        {x:1140,y:480,vx:-140,pattern:"patrol"},
        {x:1700,y:480,vx:140,pattern:"patrol"},
        {x:2100,y:480,vx:-130,pattern:"jumper"}
      ]
    },
    {
      // NÍVEL 4 — Plataformas mais estreitas, mais vilões, trampolim essencial
      name: "Nível 4 — O Direito à Educação",
      theme:3, quizTheme:"educacao", worldW:3000,
      spawn:{x:120,y:460}, doorX:2780,
      platforms:[
        {x:400,y:520,w:800,h:28},
        {x:720,y:450,w:220,h:22},
        // grupo A
        {x:1020,y:390,w:220,h:22},
        {x:1300,y:460,w:220,h:22},
        // vão com trampolim
        {x:1740,y:390,w:220,h:22},
        {x:2020,y:330,w:220,h:22},
        {x:2300,y:400,w:220,h:22},
        // chegada
        {x:2620,y:520,w:760,h:28}
      ],
      items:[
        {x:720,y:400,kind:"medalha"},
        {x:1020,y:340,kind:"estrela"},
        {x:1300,y:410,kind:"balao"},
        {x:1740,y:340,kind:"duplosalto"},
        {x:2020,y:280,kind:"brinquedo"},
        {x:400,y:470,kind:"heart"}
      ],
      trampolines:[{x:1530,y:462}],
      malwares:[
        {x:820,y:480,vx:0,pattern:"mini"},
        {x:1150,y:480,vx:-150,pattern:"patrol"},
        {x:1870,y:480,vx:150,pattern:"jumper"},
        {x:2400,y:480,vx:-145,pattern:"jumper"}
      ]
    },
    {
      // NÍVEL 5 — O mais completo: plataforma móvel, mais vilões, celebração final
      name: "Nível 5 — O Futuro é Nosso!",
      theme:10, quizTheme:"digital", worldW:3200,
      spawn:{x:120,y:460}, doorX:2980,
      platforms:[
        {x:400,y:520,w:800,h:28},
        {x:720,y:450,w:220,h:22},
        {x:1040,y:390,w:220,h:22},
        {x:1360,y:330,w:220,h:22},
        // Vale
        {x:1640,y:420,w:200,h:22},
        // Subida final
        {x:1960,y:360,w:220,h:22},
        {x:2260,y:430,w:220,h:22},
        {x:2820,y:520,w:760,h:28}
      ],
      items:[
        {x:720,y:400,kind:"balao"},
        {x:1040,y:340,kind:"medalha"},
        {x:1360,y:280,kind:"estrela"},
        {x:1640,y:370,kind:"duplosalto"},
        {x:1960,y:310,kind:"brinquedo"},
        {x:400,y:470,kind:"heart"}
      ],
      trampolines:[{x:2080,y:462}],
      movingPlatforms:[
        {x:1800,y:390,w:160,h:22,rangeX:120,rangeY:0,speed:70}
      ],
      malwares:[
        {x:820,y:480,vx:0,pattern:"mini"},
        {x:1180,y:480,vx:-155,pattern:"patrol"},
        {x:1500,y:480,vx:155,pattern:"patrol"},
        {x:2080,y:480,vx:-150,pattern:"jumper"},
        {x:2380,y:480,vx:145,pattern:"jumper"}
      ]
    },
  ];
  ...
  function difficultyFactor(idx) {
    // 5 níveis: factor suave 1.0 → 1.12
    return 1 + idx * 0.03;
  }1.35 em vez de 1.85
  }
  ...
  function loadLevel(scene,idx) {
    ...
    // Vilões definidos por nível em L.malwares (sem spawn automático extra)
    ...
    const TIPS = [
      ...
      "🦘 Usa os trampolins laranjas para saltar mais alto!",
